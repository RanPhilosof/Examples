...
public class UdpServerApp : IServerCommunication
{
    ...
    public UdpServerApp(int port, int serverMtu, int keepAliveTimeout, int bufferSize, int maxClients)
    {
...
public class UdpClientApp : IClientCommunication
{
    private readonly Socket _udpSocket;
    ...
    public UdpClientApp(string serverAddress, int serverPort, int clientMtu, int bufferSize)
    {
