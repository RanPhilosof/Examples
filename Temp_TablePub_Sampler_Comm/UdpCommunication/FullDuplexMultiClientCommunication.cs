...
//using static Elisra.Infra.FullDuplexMultiClientCommunication.Server<T>;

namespace Elisra.Infra.FullDuplexMultiClientCommunication
{
    ...
    /*
    public class AsynchornousClient<T> where T : ICommunicationSerialiable, new()
    {
        ...
        public AsynchornousClient(
            Client<T> client,
            TaskPriority sendDataPriority)
        {
            this.client = client;
        ...
        public void SendData(T t)
        {
            ...
            sc.Schedule("SendData", (int)sendDataPriority, client.SendData, t);
        }
