...
namespace StateOfTheArtTablePublisher
{
    ...
    public interface ITablePublisherCacheMonitoring : IName, IGuid
    {
        bool Available { get; }
        List<List<string>> GetInnerCachedTable();
    }

    public interface ITablePublisherCacheMonitoringTypeConverter<TOut, TOutSlim>
    {
        Func<List<Tuple<TOut, TOutSlim, uint>>, List<List<string>>> ToMonitorTypeConverter { get; set; }
    }

    public interface ITablePublisher<TIn, TOut, TOutSlim, TId> : ITablePublisherCacheMonitoring, ITablePublisherCacheMonitoringTypeConverter<TOut, TOutSlim>, IDisposable
    {                
        void Initiliaze(
            string tableName,
